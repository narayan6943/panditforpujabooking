...
export const WhatsAppButton: React.FC = () => {
  const phoneNumber = '918446272142' // WhatsApp format: country code + number (no + or dashes)
  const whatsappUrl = `https://wa.me/${phoneNumber}`
  const message = encodeURIComponent('Hello! I would like to book a pandit for puja services.')
  ...
  return (
    <a
      ...
      aria-label="Contact us on WhatsApp +91-8446272142"
