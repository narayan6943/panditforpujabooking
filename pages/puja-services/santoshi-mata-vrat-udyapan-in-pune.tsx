...
export default function SantoshiMataVratUdyapanPage() {
    ...
    const serviceSchema = generateServiceSchema({
        ...
        ratingValue: '4.8',
        url: 'https://panditforpujabooking.com/puja-services/santoshi-mata-vrat-udyapan-in-pune',
    ...
    return (
        <>
            <SEOHead
                ...
                canonicalUrl="https://panditforpujabooking.com/puja-services/santoshi-mata-vrat-udyapan-in-pune"
