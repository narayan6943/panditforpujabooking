...
export default function SatyanarayanPujaPage() {
    ...
    const serviceSchema = generateServiceSchema({
        ...
        reviewCount: '980',
        ratingValue: '4.8',
        url: 'https://panditforpujabooking.com/puja-services/satyanarayan-puja-in-pune',
    ...
    return (
        <>
            <SEOHead
                ...
                canonicalUrl="https://panditforpujabooking.com/puja-services/satyanarayan-puja-in-pune"
