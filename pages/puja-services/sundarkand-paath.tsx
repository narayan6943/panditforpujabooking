                            ...
                            <div id="booking" className="bg-white rounded-xl shadow-xl border-t-4 border-saffron-500 p-6 sticky top-24">
                                ...
                                <form className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-saffron-500 focus:border-transparent" placeholder="e.g. Sinhagad Road" />
                                    </div>
                                    ...
                                    <p className="text-xs text-center text-gray-500 mt-2">
                                        We check availability and confirm.
                                    </p>
                                </form>
                            </div>
