...
export default function SaraswatiPujaPage() {
    ...
    const serviceSchema = generateServiceSchema({
        ...
        ratingValue: '4.8',
        url: 'https://panditforpujabooking.com/puja-services/saraswati-puja-in-pune',
    ...
    return (
        <>
            <SEOHead
                ...
                canonicalUrl="https://panditforpujabooking.com/puja-services/saraswati-puja-in-pune"
