...
export default function NavagrahaPujaPage() {
    ...
    const baseServiceSchema = generateServiceSchema({
        ...
        ratingValue: '4.8',
        url: 'https://panditforpujabooking.com/puja-services/navagraha-puja-in-pune',
    ...
    return (
        <>
            <SEOHead
                ...
                canonicalUrl="https://panditforpujabooking.com/puja-services/navagraha-puja-in-pune"
