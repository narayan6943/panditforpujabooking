...
export default function PradoshVratUdyapanPage() {
    ...
    const serviceSchema = generateServiceSchema({
        ...
        ratingValue: '4.9',
        url: 'https://panditforpujabooking.com/puja-services/pradosh-vrat-udyapan-in-pune',
    ...
    return (
        <>
            <SEOHead
                ...
                canonicalUrl="https://panditforpujabooking.com/puja-services/pradosh-vrat-udyapan-in-pune"
