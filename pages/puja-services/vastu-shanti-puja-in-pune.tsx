...
export default function VastuShantiPujaPage() {
    const baseServiceSchema = generateServiceSchema({
        ...
        reviewCount: '480',
        ratingValue: '4.8',
        url: 'https://panditforpujabooking.com/puja-services/vastu-shanti-puja-in-pune',
    ...
    return (
        <>
            <SEOHead
                ...
                canonicalUrl="https://panditforpujabooking.com/puja-services/vastu-shanti-puja-in-pune"
